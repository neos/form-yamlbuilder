...
(function() {
  var Neos, convertToSimpleObject, javaScript, stylesheet, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
    _this = this,
  ...
  Neos.FormBuilder.Model.FormElementType = Ember.Object.extend({
    ...
    __cssClassNames: (function() {
      return "neos-formbuilder-group-" + (this.getPath('formBuilder.group')) + " neos-formbuilder-type-" + (this.get('type').toLowerCase().replace(/[^a-z0-9]/g, '-'));
  ...
  Neos.FormBuilder.View.Application = Ember.View.extend({
    ...
    addLayout: function() {
      ...
      return $('#neos-formbuilder-elementSidebar').layout({
        defaults: {
          minSize: 100,
          closable: false,
          slidable: false,
  ...
  Neos.FormBuilder.View.Stage = Ember.View.extend({
    ...
    onCurrentElementChanges: (function() {
      ...
      this.$().find('.neos-formbuilder-form-element-selected').removeClass('neos-formbuilder-form-element-selected');
      ...
      return this.$().find('[data-element="' + identifierPath + '"]').addClass('neos-formbuilder-form-element-selected');
    ...
    addCollectionElement: (function() {
      ...
      if (jQuery.browser.msie) {
        window.setTimeout(function() {
          var viewId;
          viewId = _this.$().find('.neos-formbuilder-addFinisher select, .neos-formbuilder-addValidator select').attr('id');
  ...
  Neos.FormBuilder.View.ElementOptionsPanel.Editor.PropertyGrid = Neos.FormBuilder.View.ElementOptionsPanel.Editor.AbstractPropertyEditor.extend({
    ...
    didInsertElement: function() {
      var moveRowsPlugin,
        _this = this;
      this.buildTableRowModel();
      this.grid = new Slick.Grid(this.$().find('.neos-formbuilder-grid'), this.get('tableRowModel'), this.get('columnDefinition'), this.get('options'));
